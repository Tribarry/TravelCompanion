const CACHE='sea2027-v13-vietnam-curation-laos-audit-a8';
const ASSETS=['./','./index.html','./styles.css','./app.js','./data/itinerary.json','./manifest.webmanifest','./data/vietnam-photo-manifest-v1.js','./data/laos-photo-manifest-v1.js'];
