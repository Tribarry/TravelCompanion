# Vietnam Experience Content V3 Audit

- Runtime destination profiles: **59** (required: all 59 Vietnam stops).
- Canonical locked-bank records exercised through the V3 writer: **1142**.
- High-value exact-content matches in the canonical bank audit: **175**.
- Exact rule bank: **106** named/high-value patterns.
