 ...
 * Repairs parser artefacts, converts research-note fragments into traveller-facing
 * cards, removes planning-only text, restores genuine experiences swallowed by
 * trailing notes, and refreshes weak/technical summaries through the V3 copy engine.
 * Route order, stay lengths, ratings and the locked source document are untouched.
 */
(()=>{
'use strict';
