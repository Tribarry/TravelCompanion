...
if(!document.querySelector('script[data-vn-photo-ui-fixes]')){
 const p=document.createElement('script');p.src='data/vietnam-photo-ui-fixes-v1.js?v=20260912-next10';p.dataset.vnPhotoUiFixes='1';document.head.appendChild(p);
}
