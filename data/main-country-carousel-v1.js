...
if(!document.querySelector('script[data-vn-next10-exact-audit]')){
 const p=document.createElement('script');p.src='data/vietnam-next10-exact-photo-audit-v1.js?v=20260912-a3';p.dataset.vnNext10ExactAudit='1';document.head.appendChild(p);
}
