...
if(!document.querySelector('script[data-vn-remaining-exact-audit]')){
 const p=document.createElement('script');p.src='data/vietnam-remaining-cities-exact-photo-audit-v1.js?v=20260912-r1';p.dataset.vnRemainingExactAudit='1';document.head.appendChild(p);
}
